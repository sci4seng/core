...
Cell: [`world-conditional`](../glossary.md#world-conditional "Params CONFIRM, inputs not") &middot; [`verdict`](../glossary.md#verdict "CONFIRM / REFUTE / neutral on (y0, y1)"): REFUTE ([`gap`](../glossary.md#gap "signed y1 - y0 from single-shot rq()") +6.50) &middot; [`verdict_n`](../glossary.md#verdict_n "N-shot verdict via stats.same"): CONFIRM ([`gap_n`](../glossary.md#gap_n "pooled-mean y1 - y0 from rq_n") -17.23)
...
| [`gap_n`](../glossary.md#gap_n "pooled-mean y1 - y0 from rq_n") | -17.23 |
| [`sd0_n`](../glossary.md#sd0_n "stddev of y0 samples in rq_n") | 74.13 |
| [`sd1_n`](../glossary.md#sd1_n "stddev of y1 samples in rq_n") | 69.25 |
| [`eps_n`](../glossary.md#eps_n "0.35 * sd(y0): same-list tolerance") | 25.94 |
| [`stress(inputs)`](../glossary.md#stress_inputs "200 perturbed UPPER-input backgrounds") | 183 / 200 CONFIRM |
| [`stress(params)`](../glossary.md#stress_params "200 perturbed lower-param backgrounds") | 74 / 200 CONFIRM |
| [`2x2 cell`](../glossary.md#cell "{universal, process, world, fragile} from (inp_cnt, par_cnt)") | [`world-conditional`](../glossary.md#world-conditional "Params CONFIRM, inputs not") |
