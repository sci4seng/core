...
Cell: [`process-conditional`](../glossary.md#process-conditional "Inputs CONFIRM, params not") &middot; [`verdict`](../glossary.md#verdict "CONFIRM / REFUTE / neutral on (y0, y1)"): CONFIRM ([`gap`](../glossary.md#gap "signed y1 - y0 from single-shot rq()") -1100.00) &middot; [`verdict_n`](../glossary.md#verdict_n "N-shot verdict via stats.same"): REFUTE ([`gap_n`](../glossary.md#gap_n "pooled-mean y1 - y0 from rq_n") +10532.43)

## Verdict (N=100 stats-grade)

| metric | value |
|---|---|
| [`verdict_n`](../glossary.md#verdict_n "N-shot verdict via stats.same") | REFUTE |
| [`gap_n`](../glossary.md#gap_n "pooled-mean y1 - y0 from rq_n") | +10532.43 |
| [`sd0_n`](../glossary.md#sd0_n "stddev of y0 samples in rq_n") | 28514.61 |
| [`sd1_n`](../glossary.md#sd1_n "stddev of y1 samples in rq_n") | 28923.46 |
| [`eps_n`](../glossary.md#eps_n "0.35 * sd(y0): same-list tolerance") | 9980.11 |
| [`stress(inputs)`](../glossary.md#stress_inputs "200 perturbed UPPER-input backgrounds") | 47 / 200 CONFIRM |
