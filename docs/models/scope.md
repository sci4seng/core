...
Cell: [`fragile`](../glossary.md#fragile "Neither axis CONFIRMs in majority") &middot; [`verdict`](../glossary.md#verdict "CONFIRM / REFUTE / neutral on (y0, y1)"): CONFIRM ([`gap`](../glossary.md#gap "signed y1 - y0 from single-shot rq()") -20.00) &middot; [`verdict_n`](../glossary.md#verdict_n "N-shot verdict via stats.same"): neutral ([`gap_n`](../glossary.md#gap_n "pooled-mean y1 - y0 from rq_n") -2.15)
...
| [`gap_n`](../glossary.md#gap_n "pooled-mean y1 - y0 from rq_n") | -2.15 |
| [`sd0_n`](../glossary.md#sd0_n "stddev of y0 samples in rq_n") | 2691.41 |
| [`sd1_n`](../glossary.md#sd1_n "stddev of y1 samples in rq_n") | 2692.24 |
| [`eps_n`](../glossary.md#eps_n "0.35 * sd(y0): same-list tolerance") | 941.99 |
| [`stress(inputs)`](../glossary.md#stress_inputs "200 perturbed UPPER-input backgrounds") | 25 / 200 CONFIRM |
| [`stress(params)`](../glossary.md#stress_params "200 perturbed lower-param backgrounds") | 28 / 200 CONFIRM |
