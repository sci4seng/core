...
Cell: [`universal`](../glossary.md#universal "Both inputs and params CONFIRM") &middot; [`verdict`](../glossary.md#verdict "CONFIRM / REFUTE / neutral on (y0, y1)"): CONFIRM ([`gap`](../glossary.md#gap "signed y1 - y0 from single-shot rq()") -69.13) &middot; [`verdict_n`](../glossary.md#verdict_n "N-shot verdict via stats.same"): CONFIRM ([`gap_n`](../glossary.md#gap_n "pooled-mean y1 - y0 from rq_n") -1183.16)
...
| [`gap_n`](../glossary.md#gap_n "pooled-mean y1 - y0 from rq_n") | -1183.16 |
| [`sd0_n`](../glossary.md#sd0_n "stddev of y0 samples in rq_n") | 1107.23 |
| [`sd1_n`](../glossary.md#sd1_n "stddev of y1 samples in rq_n") | 1435.52 |
| [`eps_n`](../glossary.md#eps_n "0.35 * sd(y0): same-list tolerance") | 387.53 |
| [`stress(inputs)`](../glossary.md#stress_inputs "200 perturbed UPPER-input backgrounds") | 197 / 200 CONFIRM |
