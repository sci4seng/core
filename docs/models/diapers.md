...
Cell: [`process-conditional`](../glossary.md#process-conditional "Inputs CONFIRM, params not") &middot; [`verdict`](../glossary.md#verdict "CONFIRM / REFUTE / neutral on (y0, y1)"): CONFIRM ([`gap`](../glossary.md#gap "signed y1 - y0 from single-shot rq()") -24.00) &middot; [`verdict_n`](../glossary.md#verdict_n "N-shot verdict via stats.same"): neutral ([`gap_n`](../glossary.md#gap_n "pooled-mean y1 - y0 from rq_n") -19.60)
...
| [`gap_n`](../glossary.md#gap_n "pooled-mean y1 - y0 from rq_n") | -19.60 |
| [`sd0_n`](../glossary.md#sd0_n "stddev of y0 samples in rq_n") | 58.42 |
| [`sd1_n`](../glossary.md#sd1_n "stddev of y1 samples in rq_n") | 63.69 |
| [`eps_n`](../glossary.md#eps_n "0.35 * sd(y0): same-list tolerance") | 20.45 |
| [`stress(inputs)`](../glossary.md#stress_inputs "200 perturbed UPPER-input backgrounds") | 84 / 200 CONFIRM |
...
| [`anomaly_check`](../glossary.md#anomaly_check "F&S behaviour-anomaly: hi inputs do not flip y sign") | FAIL |
...
| [`mr_dt_halving`](../glossary.md#mr_dt_halving "Chen MR8 / Sterman 6: y invariant to dt/2") | FAIL |
