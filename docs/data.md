...
Raw project data is **not** in this repo. Drop bundles into [sci4seng/data/dropzone/](https://github.com/sci4seng/data) and run `make refresh` (see `paper/Makefile`).

## Per-project lift coverage (8 projects)

| project | models lifted |
|---|---|
